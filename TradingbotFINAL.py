...
def opcion1(listado_tickers):
    print("Estrategia Medias Moviles Simples")
    print("\nProcesando Estrategia")

    while True:
        for ticker in listado_tickers:
            res = estrategia_cruce_sma(20, 50, ticker)
            if res == True:
                time.sleep(5)  # evita spam de alertas
...
def opcion4(listado_tickers):
    print("Estrategia MACD")
    print("\nProcesando Estrategia")

    while True:
        for ticker in listado_tickers:
            res = estrategia_macd(12, 26, 9, ticker)
            if res == True:
                time.sleep(5)
        break
